  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Positioned.fill(
              child: BlurHashImage(uri: articlesData.thumbnails[1].url!)),
          Align(
            ...
            child: Container(
              ...
              child: (articlesData.metadata != null)
                  ? Column(
                      ...
                      children: [
                        if (articlesData.metadata?.title != null)
                          Text(
                        ...
                        if (articlesData.metadata?.description != null)
                          Text(
                            articlesData.metadata!.description!,
                            maxLines: 2,
                          ),
                        const SizedBox(
                          height: 4,
                        ),
                        Text(articlesData.metadata!.publishDate,
          ...
          Positioned.fill(
              child: Material(
            type: MaterialType.transparency, // to show tapping ripple effect
            child: InkWell(
              onTap: () {
                Navigator.pushNamed(context, ArticleScreen.route,
